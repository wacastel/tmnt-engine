/* Generated offline by scripts/compile_m68k.py. Do not edit.
...
INLINE uint m68ki_get_ea_ix(uint An)
{
    return tmnt_m68k_indexed_ea(An);
}
...
INLINE void m68ki_exception_privilege_violation(void)
{
	...
	USE_CYCLES(CYC_EXCEPTION[EXCEPTION_PRIVILEGE_VIOLATION] - tmnt_m68k_base_cycles);
}
...
INLINE void m68ki_exception_1010(void)
{
	...
	/* Use up some clock cycles and undo the instruction's cycles */
	USE_CYCLES(CYC_EXCEPTION[EXCEPTION_1010] - tmnt_m68k_base_cycles);
}
...
INLINE void m68ki_exception_1111(void)
{
	...
	/* Use up some clock cycles and undo the instruction's cycles */
	USE_CYCLES(CYC_EXCEPTION[EXCEPTION_1111] - tmnt_m68k_base_cycles);
}
...
INLINE void m68ki_exception_illegal(void)
{
	...
	/* Use up some clock cycles and undo the instruction's cycles */
	USE_CYCLES(CYC_EXCEPTION[EXCEPTION_ILLEGAL_INSTRUCTION] - tmnt_m68k_base_cycles);
}
...
INLINE void m68ki_exception_format_error(void)
{
	...
	/* Use up some clock cycles and undo the instruction's cycles */
	USE_CYCLES(CYC_EXCEPTION[EXCEPTION_FORMAT_ERROR] - tmnt_m68k_base_cycles);
}
...
INLINE void m68ki_exception_address_error(void)
{
	...
	/* Use up some clock cycles and undo the instruction's cycles */
	USE_CYCLES(CYC_EXCEPTION[EXCEPTION_ADDRESS_ERROR] - tmnt_m68k_base_cycles);
}
